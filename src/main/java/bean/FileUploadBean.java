...
public class FileUploadBean implements Serializable {
	...
	private List<Analysis.Result> filteredSubResults;
	private Float defaultDist = 0.1f;
	...
	public List<Analysis.Result> getFilteredSubResults() {
		return filteredSubResults;
	}

	public void setFilteredSubResults(List<Analysis.Result> filteredSubResults) {
